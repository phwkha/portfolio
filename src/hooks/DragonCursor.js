...
import myCustomCursor from "../assets/character.png";
  ...
  return (
    <div
      style={{
        ...
        width: "100vw",
        height: "100vh",
        pointerEvents: "none", /* Chắc chắn các cú click chuột có thể xuyên qua */
        zIndex: 9999, /* Đảm bảo con rồng luôn nằm trên cùng */
      }}
    >
      <img
        ref={cursorRef}
      ...
      <svg style={{ width: "100%", height: "100%", pointerEvents: "none" }}>
        <defs>
          {/* Đưa toàn bộ LinearGradient ra ngoài để tránh lỗi mất màu cánh */}
